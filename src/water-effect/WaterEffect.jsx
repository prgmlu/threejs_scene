...
export default class WaterEffect extends Component {
    ...
    constructor(props) {
        ...
        this.distortionScale = props.distortionScale || .5;
        ...
        this.water = new Water(
            this.waterGeometry,
            {
                textureWidth: 512,
                textureHeight: 512,
                waterNormals: new THREE.TextureLoader().load( 'https://cdn.obsess-vr.com/bravo/waternormals.jpg', function ( texture ) {
