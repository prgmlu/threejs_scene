...
const Background = ({ scene, bgConf, resetBGBeforeImageLoaded, camera, linkedScenes }) => {
    ...
    return (
        isFlatScene
            ? <FlatBackground backgroundUrl={backgroundUrl} scene={scene} resetBGBeforeImageLoaded={resetBGBeforeImageLoaded} imageIntegrity={imageIntegrity}/>
            : <BackgroundCube backgroundUrl={backgroundUrl} camera={camera} scene={scene} linkedScenes={linkedScenes} imageIntegrity={imageIntegrity} useWebp={useWebp}/>
    );
};
