...
const FlatBackground = ({ scene, backgroundUrl, resetBGBeforeImageLoaded, imageIntegrity }) => {
    ...
    useEffect(() => {
        ...
        if (backgroundUrl) {
            flatBackground.current.loadTexture(`${backgroundUrl}?v=${imageIntegrity ? imageIntegrity : formatDate(new Date(), "mmddyyyyhh")}`);
        }
    }, [backgroundUrl]);
