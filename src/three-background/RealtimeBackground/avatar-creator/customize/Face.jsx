...
let updateOutfitStringForHairMesh = (outfitName, ref) => {
...
let setHairMesh = (index, currentAvatar, visibleGender) => {
	...
	if(visibleGender == 'male'){
		updateOutfitStringForHairMesh(hairMeshName, maleLocalAvatarOutfitStringRef);
	}
	else{
		updateOutfitStringForHairMesh(hairMeshName, femaleLocalAvatarOutfitStringRef);
	}
...
const Face = ({ currentAvatar, femaleLocalAvatarOutfitStringRef, maleLocalAvatarOutfitStringRef, visibleGenderRef, hairColor, eyeColor, setHairColor, setEyeColor }) => {
								...
								<img
									...
									onClick={() => {
										...
										if (selectedTone === 0) {
											...
											setHairMesh(index, window.femaleModel, femaleLocalAvatarOutfitStringRef, maleLocalAvatarOutfitStringRef, visibleGenderRef.current);
