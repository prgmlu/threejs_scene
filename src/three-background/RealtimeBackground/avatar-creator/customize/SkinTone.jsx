...
let swapSkinTexture = (textureIndex, mesh, selectedMakeup) => {
	...
	if (selectedMakeup || selectedMakeup === 0) {
		url = `https://cdn.obsess-vr.com/realtime3d/makeup-skintones/Sk${textureIndex}_FemaleAvatar${
			selectedMakeup + 1
		}_D.jpg`;
	} else
		url = `https://cdn.obsess-vr.com/realtime3d/skintones_new/Sk${textureIndex}_FemaleAvatar_D.jpg`;
