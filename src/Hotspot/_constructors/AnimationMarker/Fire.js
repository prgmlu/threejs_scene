...
export default class Fire extends THREE.Mesh {
    constructor(renderOrder = 1) {
        ...
        loaderz.crossOrigin = '';
        const fireTex = loaderz.load("https://cdn.obsess-vr.com/bravo/Fire_blue2.png");
        ...
        material.uniforms.color.value = new THREE.Color(0xeeeeee);
    ...
    updateFire = (time) => {
        ...
        // // invModelMatrix.getInverse( this.geometry.matrixWorld );
    ...
    animateComponent = () => {
        ...
        // let delta = this.geometry.clock.getDelta();
        this.updateFire(elapsedTime * 1.3);
    }
